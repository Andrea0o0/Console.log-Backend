export const kata =[
    ...
    },
    {
        ...
        "instructions": "<h4>DESCRIPTION:</h4><p>Complete the function/method so that it returns the url with anything after the anchor <span className={border}>(#)</span> removed.</p><h3>Examples:</h3><ControlledEditor value={example} options={{    lineWrapping:true, mode:'javascript', theme: 'material', readOnly:true}}/>",
